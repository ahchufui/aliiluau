        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://www.facebook.com/profile.php?id=61579908381380" target="_blank" rel="noopener noreferrer" aria-label="Facebook" 
              ...
              <a href="https://www.instagram.com/alii_luau_bne/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-9 h-9 rounded-full bg-[color:var(--primary-color)] hover:bg-[color:var(--secondary-color)] flex items-center justify-center transition-colors">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
